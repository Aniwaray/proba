...
public class SendAPackageActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_send_a_package);
    ...
    public void Next(View v){
        ...
        Intent intent = new Intent(this, SendAPackage2Activity.class);
